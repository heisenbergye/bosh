...
source bosh-src-stress-test-debug/ci/tasks/utils.sh
...
agent_path=bosh-src-stress-test-debug/src/go/src/github.com/cloudfoundry/
mkdir -p $agent_path
cp -r bosh-agent $agent_path

cd bosh-src-stress-test-debug/src
